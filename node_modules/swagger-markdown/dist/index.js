...
exports.transformFile = exports.transfromSwagger = exports.tidyMarkdown = exports.partiallyDereference = void 0;
...
const documentV3_1 = require("./transformers/documentV3");
/**
...
function transfromSwagger(inputDoc, options) {
    ...
    else if ((0, detectDocumentVersion_1.isV3Document)(inputDoc) || options.forceVersion === '3') {
        plainDocument = (0, documentV3_1.transformSwaggerV3)(inputDoc, options);
    }
